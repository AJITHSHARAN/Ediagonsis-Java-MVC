...
.nav-link
{
  font-family: font-family: 'Marcellus SC', serif;
}
.bg-img {
  /* The image used */
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)),url("docreg.jpg");
  min-height:1028px;
...
<!-- Bootstrap core CSS -->
<link href="https://fonts.googleapis.com/css?family=Julius+Sans+One|Marcellus+SC|Quicksand&display=swap" rel="stylesheet">
...
<div class="class2">
<nav class="navbar navbar-expand-lg" style="font-family: font-family: 'Marcellus SC', serif;">
  <a class="navbar-brand" href="#" style="color:white; font-family: font-family: 'Marcellus SC', serif;">E-Diagnosis</a>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      <li class="nav-item active">
        <a class="nav-link" href="#" style="color:white;font-family: font-family: 'Marcellus SC', serif;">Home <span class="sr-only">(current)</span></a>
      </li>
...
<form class="text-center border border-light p-5" style="font-family: 'Quicksand', sans-serif; " method="post" action="RegisterController_Cus">

    <p class="h4 mb-4" style="font-family: 'Julius Sans One', sans-serif;">Customer Registration</p>
