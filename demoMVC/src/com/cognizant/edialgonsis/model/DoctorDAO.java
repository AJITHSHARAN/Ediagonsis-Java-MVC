...
public class DoctorDAO {
	...
	public int getDoctorID(String dname) {
		{
		      ...
		      int result = 0;
		       ...
		       {
		           conn=DbConnector.getConnection();
		           st=conn.prepareStatement("select doctor_id from doctor where firstname=?");
	...
	public int getDoctorID1(String name) {
		...
		
		{
		      ...
		      int result = 0;
		       ...
		       {
		           conn=DbConnector.getConnection();
		           st=conn.prepareStatement("select doctor_id from doctor where email_id=?");
		            st.setString(1, name);
	...
	public List<Doctor> fetchDoctor() {
       ...
       while(rs.next())
       {
    	   ...
    	   u.setWorkhours(rs.getString(18));
    	   u.setContact(rs.getString(7));
    	   u.setHospital_name(rs.getString(19));
    	   doclist.add(u);
    	  }
		}
		catch(Exception e)
